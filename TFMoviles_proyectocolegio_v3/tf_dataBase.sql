...
CREATE TABLE IF NOT EXISTS `colegio`.`festividad` (
  ...
  `fes_descripcion` VARCHAR(225) NOT NULL,
  `fes_abono` VARCHAR(45) NOT NULL,
  `fes_fecha` VARCHAR(45) NOT NULL,
  `fes_observacion` VARCHAR(225) NOT NULL,
  `fes_latitud` DECIMAL(20,17) NOT NULL,
  `fes_longitud` DECIMAL(20,17) NOT NULL,
  PRIMARY KEY (`fes_id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `colegio`.`pago` (
  ...
  `pa_pago1` INT NOT NULL,
  `pa_pago2` INT NOT NULL,
  `pa_pago3` INT NOT NULL,
  `pa_pago4` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `colegio`.`calificacion` (
  ...
  `cal_observacion` VARCHAR(225) NULL,
  PRIMARY KEY (`cal_id`))
ENGINE = InnoDB;
...
select * from pago
INSERT INTO festividad values(0,'dia papa','celebra dia','150','12/12/2024','seguir pagando',0.0,0.0);
