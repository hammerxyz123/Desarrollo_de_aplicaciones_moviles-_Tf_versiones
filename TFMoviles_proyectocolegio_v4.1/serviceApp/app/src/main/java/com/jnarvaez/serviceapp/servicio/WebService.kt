...
import com.toledo.proyectocolegio.servicio.AlumnoResponse
import com.toledo.proyectocolegio.servicio.CalificacionResponse
import com.toledo.proyectocolegio.servicio.PagoResponse
...
interface WebService {
    ...
    @PUT("/festividad/actualizar/{id}")
    suspend fun actualizarFestividad(@Path("id")id:Int, @Body festividad: Festividad):Response<String>
    ...
    @DELETE("/festividad/eliminar/{id}")
    suspend fun eliminarFestividad(@Path("id")id:Int):Response<String>
}
